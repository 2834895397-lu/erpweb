    ...
    data () {
      return {
        ...
        url: {
          ...
          delete: "/mm/contract/deleteContractDtl",
          deleteBatch: "/mm/contract/deleteBatchContractDtl",
          exportXlsUrl: "/mm/contract/exportContractDtl",
          importUrl: "/mm/contract/importContractDtl",
        },
        dictOptions:{
          type:[],
          status:[],
