    ...
    data () {
      return {
        ...
        url: {
          ...
          delete: "/mm/order/deleteOrderDtl",
          deleteBatch: "/mm/order/deleteBatchOrderDtl",
          exportXlsUrl: "/mm/order/exportOrderDtl",
          importUrl: "/mm/order/importOrderDtl",
        },
        dictOptions:{
          type:[],
          status:[],
