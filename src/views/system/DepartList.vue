    ...
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px">
          ...
          <a-button @click="handleDownloadTemplate()" type="primary">下载数据模板</a-button>
    ...
    methods: {
     ...
     // <!---- author:os_chengtgen -- date:20190827 --  for:切换父子勾选模式 =======------>
      ...
      handleDownloadTemplate(){
        if (!this.currSelected.id) {
          this.$message.warning('请点击选择要导入用户数据部门!')
          return
        }
        window.open(window._CONFIG['domianURL'] + "/sys/sysDepart/exportExcel?id=" + this.currSelected.id)
      }
      // <!---- author:os_chengtgen -- date:20190827 --  for:切换父子勾选模式 =======------>
