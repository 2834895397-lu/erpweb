<template>
  <a-card :bordered="false" :class="'cust-erp-sub-tab'">
    ...
    <div class="table-operator" v-if="mainId">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('客户收货人')">导出</a-button>
      <a-upload
        name="file"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/bcs/profileInf/listProfileCneeByMainId",
          delete: "/bcs/profileInf/deleteProfileCnee",
          deleteBatch: "/bcs/profileInf/deleteBatchProfileCnee",
          exportXlsUrl: "/bcs/profileInf/exportProfileCnee",
          importUrl: "/bcs/profileInf/importProfileCnee",
        },
        dictOptions:{
         isUse:[],
         isCheck:[],
