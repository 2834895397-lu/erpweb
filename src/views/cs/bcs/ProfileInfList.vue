<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="供应商代码">
              <a-input placeholder="请输入供应商代码" v-model="queryParam.csCode"></a-input>
            </a-form-item>
          </a-col>
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="供应商类型">
              <j-dict-select-tag v-model="queryParam.csType"  dictCode="cs_type" placeholder="请选择供应商类型"/>
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="供应商等级">
              <j-dict-select-tag v-model="queryParam.csLevel" dictCode="cs_level" placeholder="请选择供应商等级"/>
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" type="primary" icon="plus" v-has="'bcs:profile:add'">新增</a-button>
      <a-button type="primary" icon="download" @click="handleExportXls('客商基础信息')" v-has="'bcs.profile.exportXls'">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" icon="import" v-has="'bcs.profile.importExcel'">导入</a-button>
      </a-upload>
      <a-button type="primary" @click="applyRegular" v-has="'bcs.profile.turnToFormal'">转为正式</a-button>
      <a-button type="primary" @click="counter_check" v-has="'bcs.profile.turnToInformal'">转为非正式</a-button>
      <a-button type="primary" @click="turnToBlacklist" class="blacklist" v-has="'bcs.profile.turnToBlacklist'">转为黑名单</a-button>
      <a-button type="primary" @click="removeBlacklist" class="blacklist" v-has="'bcs.profile.removeBlacklist'">解除黑名单</a-button>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'bcs.profile.edit'">编辑</a>
    ...
    <a-tabs defaultActiveKey="1">
      <a-tab-pane  tab="供应商类型" key="1" forceRender>
        <ProfileTypeLevelList :key="timer" @update_data="update_data()" :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="供应商银行账户" key="2" forceRender>
        <ProfileBankList :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="供应商归属信息" key="3" forceRender>
        <ProfileBelongList :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="供应商经营品种" key="4" forceRender>
        <ProfileProductList :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="供应商委托书" key="5" >
...
<script>
  ...
  import ProfileQualifiList from './ProfileQualifiList'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/bcs/profileInf/list",
          delete: "/bcs/profileInf/delete",
          deleteBatch: "/bcs/profileInf/deleteBatch",
          exportXlsUrl: "/bcs/profileInf/exportXls",
          importExcelUrl: "bcs/profileInf/importExcel",
          checkIt: "/bcs/profileInf/checkIt",
          counterCheck: "/bcs/profileInf/counterCheckIt",
          checkNoPass : "/bcs/profileInf/checkNoPass",
          applyRegular : "/bcs/profileInf/applyRegular",
          turnToBlacklist : "/bcs/profileInf/turnToBlacklist",
          removeBlacklist : "/bcs/profileInf/removeBlacklist",
        },
        dictOptions:{
         isUse:[],
         isCheck:[],
