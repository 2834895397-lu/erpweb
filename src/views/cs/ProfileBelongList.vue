  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/cs/profileInf/listProfileBelongByMainId",
          delete: "/cs/profileInf/deleteProfileBelong",
          deleteBatch: "/cs/profileInf/deleteBatchProfileBelong",
          exportXlsUrl: "/cs/profileInf/exportProfileBelong",
          importUrl: "/cs/profileInf/importProfileBelong",
        },
        dictOptions:{
         isUse:[],
         isCheck:[],
