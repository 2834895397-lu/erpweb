        ...
        <a-row>
          <!--<a-col :span="24">
            <a-form-item label="客商标识" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['csFlag', validatorRules.csFlag]" :trigger-change="true"
                                 dictCode="cs_flag" placeholder="请选择客商标识"/>
            </a-form-item>
          </a-col>-->
          <!--<a-col :span="24">
...
&lt;!&ndash;
              <j-dict-select-tag type="list" v-decorator="['busiProduct', validatorRules.busiProduct]" :trigger-change="true" @change="getBusiVariety" dictCode="tbd_material where pid = 0 ,name,id" placeholder="请选择经营大类"/>
&ndash;&gt;
            </a-form-item>
          </a-col>-->
          <a-col :span="24">
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          add: "/cs/profileInf/addProfileProduct",
          edit: "/cs/profileInf/editProfileProduct",
          queryBusiVariety: "cs/profileInf/queryBusiVariety"
        }
