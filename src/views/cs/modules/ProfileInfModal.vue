  ...
  <j-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-row>
          <a-col :span="24">
            <a-form-item label="客户代码" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['csCode']" placeholder="请输入客商代码" :disabled="true"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="客户名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['csName', validatorRules.csName]" placeholder="请输入客户名称"></a-input>
              <a-button @click="queryExisting" v-has="'cs:profile:add'">查询是否已有</a-button>
            </a-form-item>
          </a-col>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/cs/profileInf/add",
          edit: "/cs/profileInf/edit",
          getCsName: "/cs/profileInf/getCsName",
