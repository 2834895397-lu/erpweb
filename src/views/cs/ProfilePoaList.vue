  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/cs/profileInf/listProfilePoaByMainId",
          delete: "/cs/profileInf/deleteProfilePoa",
          deleteBatch: "/cs/profileInf/deleteBatchProfilePoa",
          exportXlsUrl: "/cs/profileInf/exportProfilePoa",
          importUrl: "/cs/profileInf/importProfilePoa",
        },
        dictOptions:{
         isUse:[],
         isCheck:[],
