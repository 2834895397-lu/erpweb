        ...
        <a-row>
          <a-col :xs="24" :sm="12">
            <a-form-item label="单据号" :labelCol="labelCol" :wrapperCol="wrapperCol">
               <a-input v-decorator="['matlInNumber']" :disabled="true"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form> 
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        edit: '/sm/matlInOrder/redFlushDtl',
        matlInOrderDtl: {
          list: '/sm/matlInOrder/queryNoRedDtlListByMainId'
        }
      }
    }
  },
  methods: {
    ...
    editAfter() {
      let fieldval = pick(this.model, 'type', 'voucherTime', 'status', 'postingDate','matlInNumber')
      this.$nextTick(() => {
