    ...
    <j-form-container :disabled="formDisabled">
      <a-form :form="form" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="结存日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择结存日期" v-decorator="['balanceDate']" :trigger-change="true" style="width: 100%"/>
            </a-form-item>
          </a-col>
  ...
  export default {
    ...
    data() {
      return {
        ...
        validatorRules: {},
        url: {
          add: '/sm/matlStock/add',
          edit: '/sm/matlStock/edit',
          queryById: '/sm/matlStock/queryById'
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit(record) {
        ...
        this.visible = true
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model, 'toTbdNodeId', 'tbdMaterialId', 'matlQty', 'balanceDate'))
        })
      },
      //渲染流程表单数据
      showFlowData() {
      ...
      popupCallback(row) {
        this.form.setFieldsValue(pick(row, 'toTbdNodeId', 'tbdMaterialId', 'matlQty', 'balanceDate'))
      }
    }
  }
</script>