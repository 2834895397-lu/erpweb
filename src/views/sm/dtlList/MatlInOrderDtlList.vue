<template>
  <a-card :bordered="false" :class="'cust-erp-sub-tab'">
    ...
    <div class="table-operator" v-if="mainId">
      ...
      <!--     <a-button type="primary" icon="download" @click="handleExportXls('收货单明细表')">导出</a-button>
           <a-upload
             name="file"
      ...
      <a-dropdown v-if="selectedRowKeys.length > 0 && pRecord.status === '0' ? true : false">
        <a-menu slot="overlay">
          <a-menu-item key="1" @click="delBatch" v-has="'inorder.delete'">
            <a-icon type="delete" />
            删除
          </a-menu-item>
        </a-menu>
  ...
  data() {
    return {
      ...
      url: {
        ...
        delete: '/sm/matlInOrder/deleteMatlInOrderDtl',
        deleteBatch: '/sm/matlInOrder/deleteBatchMatlInOrderDtl',
        exportXlsUrl: '/sm/matlInOrder/exportMatlInOrderDtl',
        importUrl: '/sm/matlInOrder/importMatlInOrderDtl',
      },
      dictOptions: {
        type: [],
        status: [],
